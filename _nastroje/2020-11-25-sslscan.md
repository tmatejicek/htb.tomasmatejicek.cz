...
Na [Fatty](/fatty) byl právě tohle klíčový detail. Starý Java klient i server trvali na `TLSv1.0` a cipheru `AES128-SHA`. Bez takového ověření bylo snadné uvíznout v dojmu, že proxy nebo MITM nefunguje, i když problém ve skutečnosti ležel v nekompatibilním TLS nastavení.
