...
- `ssh -L`,
- [Proxychains](/nastroje/proxychains),
- reverzních tunelů,
...
`socat` často vytváří jeden přesný most. Není to automaticky náhrada za obecný SOCKS pivot nebo správu většího vnitřního prostoru přes [Proxychains](/nastroje/proxychains) ani za reverzní tunel, který nejdřív staví [Chisel](/nastroje/chisel).
