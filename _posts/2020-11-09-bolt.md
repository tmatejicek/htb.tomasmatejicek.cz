...
- První skutečně užitečný závěr plynul z toho, jak do sebe zapadly `passbolt.bolt.htb`, nginx a SSH.
...
- V tomhle článku se první slabé místo otevřelo přes `passbolt.bolt.htb`, nginx a SSH. Webová vrstva nesmí publikovat víc, než je nezbytné; vedlejší vhost, debug endpoint nebo zapomenutý soubor často odhalí skutečný vstup do řetězce.
