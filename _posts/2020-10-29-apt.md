...
Praktický základ takového skenu popisuji i v článku [Nmap](/nastroje/nmap).
...
V anonymním SMB share `backup` najdu soubor `backup.zip`. Praktický kontext práce s podobnými share shrnuji i v článku [smbclient](/nastroje/smbclient).
...
V záloze jsou soubory `ntds.dit` a `SYSTEM`, takže jde offline vytáhnout NTLM hashe. Právě tenhle okamžik je popsán obecněji i v článku [Doménové zálohy a offline těžba tajemství](/techniky/domenove-zalohy-a-offline-tezba-tajemstvi).
