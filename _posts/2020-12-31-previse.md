...
Prakticky tady dává smysl sáhnout po [John the Ripper](/nastroje/john-the-ripper), protože nejde o guessing naslepo, ale o ověření konkrétního hashe získaného z databáze.
...
Je to přesně ten typ lokální eskalace, který rozebírám v článku [PATH, PYTHONPATH a wrapper hijack](/techniky/path-pythonpath-a-wrapper-hijack): root nepadá kvůli samotnému backup skriptu, ale proto, že privilegovaný wrapper slepě důvěřuje prostředí.
