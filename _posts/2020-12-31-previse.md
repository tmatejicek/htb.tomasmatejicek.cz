...
Previse je stroj z Hack The Box. Článek sleduje cestu od prvotní enumerace k ověřenému přístupu a průběžně vysvětluje, proč měl každý další krok technický smysl.
...
- Privilegované skripty musí volat binárky absolutní cestou a čistit `PATH`, jinak jsou náchylné na path injection i bez složité exploitační logiky.
