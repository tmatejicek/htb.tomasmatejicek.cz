...
Praktický základ tohoto prvního mapování rozebírám i samostatně v článku [Nmap](/nastroje/nmap).
...
Je to stejný vzorec, který obecně shrnuji i v článku [PATH, PYTHONPATH a wrapper hijack](/techniky/path-pythonpath-a-wrapper-hijack).
