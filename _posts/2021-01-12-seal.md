...
Právě proto je tenhle stroj užitečný didakticky. První shell nevznikl klasickou webovou zranitelností v aplikaci, ale z uniklých Tomcat přihlašovacích údajů v repozitářové historii. Další pivot pak nevedl přes heslo, ale přes zálohu, která kopírovala symlinky.
...
Manager nebyl vystavený přímo, ale šel obejít přes známý pattern s `..;/` v cestě za reverse proxy:
