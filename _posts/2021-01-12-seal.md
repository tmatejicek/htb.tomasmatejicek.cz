...
- V tomhle článku se první slabé místo otevřelo přes webová aplikace v PHP, nginx a SSH. Tomcat manager, uživatelské role a soubory jako `tomcat-users.xml` nesmějí být čitelné z webu ani z LFI; deployment rozhraní je z obranného pohledu přímo vstup pro RCE.
