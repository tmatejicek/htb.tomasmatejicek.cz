...
- Automatizační nástroje typu Ansible nesmějí být delegované přes `sudo` bez tvrdého omezení vstupních souborů a parametrů, jinak se mění v přímou cestu k rootovi.
