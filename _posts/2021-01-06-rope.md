...
Přepínač `-p` zachová efektivní UID procesu a vrátí root shell. Nejde o „trik“, ale o přímý důsledek toho, že interaktivní shell byl omylem označený jako SUID binárka. Tenhle typ chyby rozebírám i obecněji v článku [SUID/GTFOBins a netypické binárky](/techniky/suid-gtfobins-a-netypicke-binarky).
