...
- User část byla skutečný memory corruption exploit ve vlastní HTTP službě.
- Root část byla naopak triviální konfigurační chyba v podobě SUID `bash`.
- Rope dobře ukazuje, že jeden stroj může kombinovat velmi pracný exploit i elementární chybu v hardeningu.
