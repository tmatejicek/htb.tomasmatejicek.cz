...
Sharp stojí na kombinaci špatně chráněných SMB sdílení a nebezpečného .NET remoting debug endpointu. První část řetězce je spíš forenzní práce s artefakty uloženými na share, druhá už je klasická deserializační vzdálená exekuce.

Z didaktického pohledu je zajímavé, že jednotlivé stopy samy o sobě nejsou rozhodující. PortableKanban databáze přinese hesla, ale ne okamžitý shell. Až teprve obsah share `dev`, zejména binárky klienta a poznámka o chybějící validaci vstupu, ukáže, že skutečný cíl je interní remoting služba na portu `8888`.
