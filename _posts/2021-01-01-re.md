...
Web s titulkem `Ghidra Dropbox Coming Soon!` sám o sobě nestačil, ale kombinace IIS a SMB už byla zajímavější. Share `malware_dropbox` byl dostupný bez běžných doménových pověření a dávalo smysl ho vyzkoušet jako vstupní bod do interní pipeline:
