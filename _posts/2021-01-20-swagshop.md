...
- První shell vznikl až řetězením dvou starších, ale stále zneužitelných chyb v Magento.
- Aplikační konfigurace znovu poskytla heslo použitelné i pro systémového uživatele.
- Root část nakonec stála na nebezpečném `sudo` oprávnění pro `vi`, ne na další webové chybě.
