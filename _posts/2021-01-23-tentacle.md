...
Samotný skript byl nebezpečný tím, že nekriticky kopíroval obsah `/var/log/squid/` do domovského adresáře `admin`, takže root část v sobě mísí dva vzorce: [logy jako útokovou plochu](/techniky/logy-jako-utokova-plocha) a [provozní automatiku jako zdroj přístupu](/techniky/udrzbove-skripty-a-provozni-automaty-jako-zdroj-pristupu):
