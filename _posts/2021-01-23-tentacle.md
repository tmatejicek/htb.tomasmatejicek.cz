...
Po nastavení `proxychains` přes veřejný Squid šlo osahat interní web na `wpad.realcorp.htb` a stáhnout `wpad.dat`. Praktickou roli tohoto nástroje v podobných pivotech rozebírám i v článku [Proxychains](/nastroje/proxychains):
