...
Root část už je naopak čistá lokální konfigurace. Účet `pericles` může zapisovat do skriptu spouštěného systemd timerem každých pár sekund, takže není potřeba žádný další exploit. Stačí počkat, až timer vykoná upravený skript jako root, tedy přesně na patternu [zápisu do prostoru, který se pak vykoná](/techniky/zapis-do-prostoru-ktery-se-pak-vykona-nebo-pouzije-pro-autentizaci).
