...
Veřejné write-upy proto vytvářejí škodlivý `docx`, ve kterém je XML upravené tak, aby převodník načetl externí DTD nebo lokální soubory. Tím šlo potvrdit XXE a následně zneužít převodní řetězec na `convert.php` k získání kódu na serveru. Jedním z doložených artefaktů této fáze je následující dvojice kroků:
...
Samostatná root fáze mířila na interní službu na portu `8888`, která už při skenu působila jako vlastní dokumentový backend. Veřejně dostupné synopse i write-upy ji popisují jako PDF generátor s paměťovou chybou; po prvním footholdu tedy dávalo smysl obrátit pozornost právě tam.
