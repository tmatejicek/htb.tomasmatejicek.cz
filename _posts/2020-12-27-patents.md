...
- Release notes a composer metadata přesně nasměrovaly analýzu k převodnímu backendu a XXE.
- User foothold stál na zneužití document conversion pipeline, ne na klasické webové RCE v jedné URL.
- Root část byla samostatná chyba v interní službě na portu `8888`, takže šlo o dva odlišné problémy v jednom stroji.
...
- Upload formuláře a následné zpracování obrázků nebo dokumentů musí mít vícevrstvou validaci; samotná kontrola přípony nebo MIME typu nestačí.