...
- User fáze se opírala o stabilní uživatelský přístup opřený o `installed.json`, takže přístup byl reprodukovatelný a ne jen jednorázový.
