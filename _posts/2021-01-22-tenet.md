...
To je přímo insecure deserialization. Útočník kontroluje objekt, který se předá do `unserialize()`, a díky `__destruct()` může zapsat libovolný obsah do libovolného souboru v adresáři aplikace.
...
A protože na systému existoval i účet `neil`, bylo rozumné zkusit reuse právě sem:
